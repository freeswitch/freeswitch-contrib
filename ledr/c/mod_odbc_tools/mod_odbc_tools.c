...
SWITCH_MODULE_SHUTDOWN_FUNCTION(mod_odbc_tools_shutdown);
SWITCH_MODULE_LOAD_FUNCTION(mod_odbc_tools_load);
SWITCH_MODULE_DEFINITION(mod_odbc_tools, mod_odbc_tools_load, mod_odbc_tools_shutdown, NULL);
...
SWITCH_MODULE_LOAD_FUNCTION(mod_odbc_tools_load)
{
  ...
  switch_log_printf(SWITCH_CHANNEL_LOG, SWITCH_LOG_INFO, "ODBC Tools module loading...\n");
...
/*
  ...
  Macro expands to: switch_status_t mod_odbc_tools_shutdown() */
SWITCH_MODULE_SHUTDOWN_FUNCTION(mod_odbc_tools_shutdown)
{
  query_t *query;
  switch_hash_index_t *hi;
