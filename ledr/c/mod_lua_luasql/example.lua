-- example.lua - just put this script in scripts/ and run it from you fs_cli
...
--[[ output on your fs_cli should be :

freeswitch@internal> lua example.lua
                      bar : 2
                      foo : 1
